...
- Replaced the placeholder `pdf-processing` fixture with an operational skill:
  - `skills-catalog/pdf-processing/SKILL.md`
  - `skills-catalog/pdf-processing/scripts/extract_pdf_tables.py`
...
- Functional fake-Pi check from a different cwd (`vindulautils`) found `pdf-processing` through the default `skills-catalog/` path and loaded instructions containing `scripts/extract_pdf_tables.py`.
