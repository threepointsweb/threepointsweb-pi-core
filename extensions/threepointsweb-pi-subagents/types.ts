...
export const DEFAULT_AGENT_NAMES = ["general-purpose", "Explore", "Web Research", "Systematic Debugging", "SEO GEO Agent Search", "Implement", "Review", "Code Simplifier", "Remove Slop"] as const;
